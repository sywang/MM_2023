...
###### cpu
bsub -q new-medium -R "rusage[mem=15000]" "module load miniconda/22.11.1_environmentally; conda activate CLL_2024;cd ~/repos/MM_2023/; export JUPYTER_ALLOW_INSECURE_WRITES=True; jupyter notebook --no-browser --port 28889 --ip='0.0.0.0'"
